...
TEXT = {
    "zh": {
        ...
        "ch_trend_title":  "趋势(最近 1 年)",
        "ch_trend_raw":    "每日利差",
        "ch_trend_ma":     "20 日均线",
        "ch_trend_verdict": "过去一个月,均线方向:",
        "ch_trend_down":   "在收窄(往 0 走)",
        "ch_trend_up":     "在走宽(远离 0)",
        "ch_trend_flat":   "基本没动",
        ...
        "dk_cfg_stale":    "config.py 版本对不上,缺少这几项配置:{keys}。这次改动同时动了 app.py 和 config.py,两个要一起上传。",
        "dk_asof":         "图上“现在”是 {month},不是本月——核心PCE 发布比初请晚,两条序列对齐后只能取到都有数的最后一个月(落后约 {lag} 个月)。",
        "dk_grid_title":   "四象限位置",
    ...
    "en": {
        ...
        "ch_trend_title":  "Trend (last 12 months)",
        "ch_trend_raw":    "Daily spread",
        "ch_trend_ma":     "20-day average",
        "ch_trend_verdict": "Direction of the average over the past month: ",
        "ch_trend_down":   "narrowing (toward zero)",
        "ch_trend_up":     "widening (away from zero)",
        ...
        "dk_cfg_stale":    "config.py is out of sync — these settings are missing: {keys}. This change touched both app.py and config.py; they have to be uploaded together.",
        "dk_asof":         "The latest point is {month}, not this month — core PCE is released later than claims, so the aligned series ends at the last month both cover (about {lag} months behind).",
